	...
	],
	{
		variants: {
			variant: {
				...
				info: "border-info/30 bg-info [&>svg]:text-info-foreground",
				success: "border-success/30 bg-success [&>svg]:text-success-foreground",
				warning: "border-warning/30 bg-warning [&>svg]:text-warning-foreground",
				invert:
